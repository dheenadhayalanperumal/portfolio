    ...
    <ScrollView style={styles.container}>
      <View>
        ...
        <Text style={styles.text}>
          dheenadhayalanperumal@gmail.com built the Mokshapada 3D game as a Free game. This SERVICE is provided by
          dheenadhayalanperumal@gmail.com at no cost and is intended for use as is.
        </Text>
        <Text style={styles.text}>
        ...
        <Text style={styles.text}>
          ...
          Mokshapada 3D unless otherwise defined in this Privacy Policy.
        </Text>
        ...
        <Text style={styles.text}>
          ...
          information, including but not limited to Username, Email-ID. The information that I request will be retained on your
        ...
        <Text style={styles.text}>Link to the privacy policy of third-party service providers used by the Game:</Text>
        <Text style={styles.text}>- Google Play Services</Text>
        <Text style={styles.text}>- Firebase Crashlytics</Text>
        <Text style={styles.text}>- Unity</Text>

        <Text style={styles.subtitle}>Log Data</Text>
        <Text style={styles.text}>
          I want to inform you that whenever you use my Service, in a case of an error in the Game I collect data and information
          (through third-party products) on your phone called Log Data. This Log Data may include information such as your device
          Internet Protocol (“IP”) address, device name, operating system version, the configuration of the Game when utilizing my
        ...
        <Text style={styles.text}>
          This Service does not use these “cookies” explicitly. However, the Game may use third-party code and libraries that use
        ...
        <Text style={styles.text}>- To assist us in analyzing how our Service is used.</Text>
        <Text style={styles.text}>
        ...
        <Text style={styles.text}>
          ...
          protecting it. But remember that no method of transmission over the internet, or method of electronic storage is 100%
        ...
        <Text style={styles.text}>
          ...
          information, I immediately delete this from our servers. If you are a parent or guardian and you are aware that your child
          has provided us with personal information, please contact me so that I will be able to do the necessary actions.
        </Text>
        ...
        <Text style={styles.text}>This policy is effective as of 2024-09-20.</Text>
